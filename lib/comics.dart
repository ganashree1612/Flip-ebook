...
import 'Bookpage1.dart'; // Import ComicsReadPage
...
class _ComicsState extends State<Comics> {
  ...
  final String bookId = 'Comics Collection';
  ...
  void initState() {
    ...
    //     item['title'] == 'Comics Collection' &&
    //     item['author'] == 'Comic Fan');
  }
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/comics.jpg',
      'title': 'Comics Collection',
      'author': 'Comic Fan',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Comic Fan was an American writer, best known for his 1951 novel The Comics Collection. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Comics Collection is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
