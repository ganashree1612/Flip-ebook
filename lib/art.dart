...
import 'Bookpage1.dart'; // Import ArtReadPage
...
class _ArtState extends State<Art> {
  ...
  final String bookId = 'Art Of Photography';
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/artp.jpg',
      'title': 'Art of Photography',
      'author': 'Jane Doe',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Jane Doe was an American writer, best known for his 1951 novel The Art of Photography. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Art of Photography is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
