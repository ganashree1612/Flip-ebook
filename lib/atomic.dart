...
import 'Bookmark.dart'; // Import BookmarkPage // Import AtomicReadPage
import 'thirdpage.dart';
class Atomic extends StatefulWidget {
  @override
  _AtomicState createState() => _AtomicState();
}

class _AtomicState extends State<Atomic> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  bool isBookmarked = false;
  final String bookId = 'Atomic Habits';
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/book5.png',
      'title': 'Atomic Habits',
      'author': 'James Clear',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'James Clear was an American writer, best known for his 1951 novel The Atomic Habits. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Atomic Habits is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      // Navigate to AtomicReadPage
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                Thirdpage()), // Corrected navigation
                      );
                    },
