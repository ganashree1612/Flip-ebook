...
import 'Bookpage1.dart'; // Import TimeReadPage
import 'timecontent.dart';
...
class _TimeState extends State<Time> {
  ...
  final String bookId = 'Time machine'; // Unique identifier for the book
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/time.jpg',
      'title': 'Time machine',
      'author': 'J.D. Salinger',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'J.D. Salinger was an American writer, best known for his 1951 novel The Time machine. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Time machine is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      // Navigate to TimeReadPage
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                Timeread()), // Corrected navigation
                      );
                    },
