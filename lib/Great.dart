...
import 'Bookpage1.dart'; // Import GreatReadPage
...
class _GreatState extends State<Great> {
  ...
  final String bookId = 'The Great Gatsby';
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/greatgatsby.jpeg',
      'title': 'The Great Gatsby',
      'author': 'F. Scott Fitzgerald',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/startpage/greatgatsby.jpeg',
                height: 140,
              ),
            ),
            SizedBox(height: 16),
            ...
            SizedBox(height: 8),
            Text(
              'F. Scott Fitzgerald was an American writer, best known for his 1951 novel The The Great Gatsby. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The The Great Gatsby is a novel by F. Scott Fitzgerald, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
