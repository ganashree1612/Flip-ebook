...
import 'Bookpage1.dart'; // Import TravelReadPage
...
class _TravelState extends State<Travel> {
  ...
  final String bookId = 'Travel Adventures';
  @override
  void initState() {
    super.initState();
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/travel.ipg.jpg',
      'title': 'Travel Adventures',
      'author': 'John Doe',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/startpage/travel.ipg.jpg',
                height: 140,
              ),
            ),
            SizedBox(height: 16),
            ...
            SizedBox(height: 8),
            Text(
              'John Doe was an American writer, best known for his 1951 novel The Travel Adventures. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Travel Adventures is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
