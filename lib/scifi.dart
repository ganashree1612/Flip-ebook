...
import 'Bookpage1.dart'; // Import ScifiReadPage
import 'fourthpage.dart';
class Scifi extends StatefulWidget {
  @override
  _ScifiState createState() => _ScifiState();
}

class _ScifiState extends State<Scifi> {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  bool isBookmarked = false;
  final String bookId = 'Sci-Fi Wonders';
  ...
  void initState() {
    ...
    //     item['title'] == 'Sci-Fi Wonders' &&
    //     item['author'] == 'Sci Fi Guru');
  }
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/scifijpeg.jpeg',
      'title': 'Sci-Fi Wonders',
      'author': 'Sci Fi Guru',
      'price': 200, // Replace with actual price
      'quantity': 1,
    });
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/startpage/scifijpeg.jpeg',
                height: 140,
              ),
            ),
            SizedBox(height: 16),
            ...
            SizedBox(height: 8),
            Text(
              'Sci Fi Guru was an American writer, best known for his 1951 novel The Sci-Fi Wonders. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Sci-Fi Wonders is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      // Navigate to ScifiReadPage
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                Fourthpage()), // Corrected navigation
                      );
                    },
