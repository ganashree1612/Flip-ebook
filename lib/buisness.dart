...
import 'Bookpage1.dart'; // Import BuisnessReadPage
...
class _BuisnessState extends State<Buisness> {
  ...
  final String bookId = 'Buisness Strategy';
  ...
  void initState() {
    ...
    //     item['title'] == 'Business Strategies' &&
    //     item['author'] == 'Business Expert');
  }
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/the_lost_world.png',
      'title': 'Business Strategies',
      'author': 'Business Expert',
      'price': 350, // Replace with actual price
      'quantity': 1,
    });
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Business Expert was an American writer, best known for his 1951 novel The Business Strategies. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Business Strategies is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
