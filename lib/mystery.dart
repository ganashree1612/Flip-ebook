...
import 'Bookpage1.dart'; // Import MysteryReadPage
...
class _MysteryState extends State<Mystery> {
  ...
  final String bookId = 'Mystery in the Horror';
  ...
  void initState() {
    ...
    //     item['title'] == 'Mystery in the Horror' &&
    //     item['author'] == 'Ghost Writer');
  }
  ...
  Future<void> addToCart() async {
    ...
    Cart.items.add({
      'image': 'assets/startpage/mystery.jpeg',
      'title': 'Mystery in the Horror',
      'author': 'Ghost Writer',
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Center(
              child: Image.asset(
                'assets/startpage/mystery.jpeg',
                height: 140,
              ),
            ),
            SizedBox(height: 16),
            Text(
              'Mystery in the Horror',
            ...
            SizedBox(height: 8),
            Text(
              'Ghost Writer was an American writer, best known for his 1951 novel The Mystery in the Horror. Before its publication, Salinger published several short stories in Story magazine.',
            ...
            SizedBox(height: 8),
            Text(
              'The Mystery in the Horror is a novel by J. D. Salinger, partially published in serial form in 1945-1946 and as a novel in 1951. It was originally intended for adults but is often read by adolescents for its theme of angst, alienation, and as a critique of superficiality in society.',
              style: TextStyle(fontSize: 16),
            ),
            Spacer(),
            Row(
