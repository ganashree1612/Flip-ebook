...
import 'package:new_project/start.dart'; // Update with the correct path to start.dart
import 'package:new_project/genres.dart'; // Import genres.dart file
import 'package:new_project/signup.dart'; // Import signup.dart file
import 'package:new_project/forgotpass.dart'; // Import forgotpass.dart file
import 'package:new_project/mainhome.dart';
import 'package:new_project/otp.dart'; // Import otp.dart file for OTP verification screen
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
                height: 20), // Add some spacing between TextField and Button
            ElevatedButton(
